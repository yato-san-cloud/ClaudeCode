...
- 📊 **サマリー**: 3PL 判断材料の主要 KPI を 1 画面で一覧
  - ボリューム: 総ピース / 総ライン / 総 PS / 入荷
  - 効率指標: **行/PS**(ライン/オーダー) / **ピース/PS** / **ピース/行** / **PS/SKU**
  - 偏り・健全性: マルチライン率 / 上位10%SKU集中度 / 平均回転率 / デッドストックSKU率
  - ピーク: ピーク曜日 / ピーク日 / アクティブ・マスタ SKU
  - ミニチャート(日次推移・曜日別)+ 上位 SKU / デッドストック上位
