...
FIELDS = {
    ...
    "起票元":   {"type": "RADIO_BUTTON", "code": "起票元", "label": "起票元",
                 "options": {"現場連絡票": {"label": "現場連絡票", "index": "0"},
                             "データ検知": {"label": "データ検知", "index": "1"}},
                 "defaultValue": "現場連絡票"},
    "突合結果": {"type": "DROP_DOWN", "code": "突合結果", "label": "突合結果",
                 "options": {"未突合": {"label": "未突合", "index": "0"},
                             "両側一致": {"label": "両側一致", "index": "1"},
                             "連絡票のみ(データ異常なし)": {"label": "連絡票のみ(データ異常なし)", "index": "2"},
                             "データのみ(連絡票なし)": {"label": "データのみ(連絡票なし)", "index": "3"}},
                 "defaultValue": "未突合"},
...
LAYOUT = [
    ...
    {"type": "ROW", "fields": [{"type": "RADIO_BUTTON", "code": "起票元"},
                               {"type": "DROP_DOWN", "code": "突合結果", "size": {"width": "220"}}]},
